...
import { assertPublicEnv } from './publicEnvSecurity'

const supabaseUrl     = import.meta.env.VITE_SUPABASE_URL
const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY

// Reject privileged keys in every mode. Vite uses the same check before build.
assertPublicEnv(import.meta.env)
