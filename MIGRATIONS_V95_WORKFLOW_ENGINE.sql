-- ============================================================================
-- MIGRATIONS_V95_WORKFLOW_ENGINE.sql
...
--     a domain event (trigger_event, consumed via V94's event_consumers).
...
--
-- Depends on: V94 (domain_events, event_consumers, emit_domain_event),
