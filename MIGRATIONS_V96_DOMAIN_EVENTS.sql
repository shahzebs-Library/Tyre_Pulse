-- ============================================================================
-- MIGRATIONS_V96_DOMAIN_EVENTS.sql
...
-- V99, webhooks V101, business rules V102), and a pg_cron-driven processor
...
-- Knowledge documents (V100 auto-embedding consumes this)
