...
class _ChecklistsHomeScreenState extends ConsumerState<ChecklistsHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return TpScaffold(
      ...
      body: _body(l10n, fleet),
    );
  }

  Widget _body(AppLocalizations l10n, List<VehicleAsset> fleet) {
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          _ChecklistHubLink(
            ...
            title: l10n.checklistsAssetHistoryTitle(
              selectedAssetNo ?? l10n.checklistNoAssetLabel,
            ),
            onTap: _openHistory,
          ),
        ],
