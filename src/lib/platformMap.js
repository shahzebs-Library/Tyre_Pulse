...
export const BACKEND_CAPABILITIES = [
  ...
  { label: 'Database & RLS', group: 'Data security', count: 356, status: 'Protected', to: '/console/security-audit', what: 'Tenant isolation, row policies, privileged functions and security findings.' },
  { label: 'API & Integrations', group: 'Connectivity', count: null, status: 'Governed', to: '/console/config', what: 'Public API keys, ERP connectors, webhooks and external provider configuration.' },
