...
export default function InstallPwaPrompt() {
  ...
  if (showIosHint) {
    return (
      <div
        role="dialog"
        aria-label="Install TyrePulse on iPhone"
        ...
        <div className="max-w-md mx-auto">
          <div className="flex items-start justify-between gap-3 mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-slate-100">Install TyrePulse</p>
                <p className="text-xs text-slate-400">Add to your Home Screen</p>
              </div>
            </div>
            <button onClick={handleDismiss} aria-label="Close" className="text-slate-500 hover:text-slate-300 transition-colors">
              <X className="w-5 h-5" />
            </button>
          </div>
          <ol className="space-y-2 text-xs text-slate-300">
            <li className="flex items-center gap-2">
              ...
              <span>Tap <Share className="w-3.5 h-3.5 inline mx-0.5 text-blue-400" /> <strong>Share</strong> in the Safari toolbar</span>
            </li>
            <li className="flex items-center gap-2">
              ...
              <span>Scroll and tap <strong>Add to Home Screen <Plus className="w-3.5 h-3.5 inline mx-0.5 text-blue-400" /></strong></span>
            </li>
            <li className="flex items-center gap-2">
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <button onClick={handleDismiss} aria-label="Dismiss" className="text-slate-500 hover:text-slate-300 transition-colors flex-shrink-0">
          <X className="w-4 h-4" />
        </button>
      </div>
    </div>
