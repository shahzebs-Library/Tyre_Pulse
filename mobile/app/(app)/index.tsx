...
import { OfflineInspection } from '../../lib/types'
      ...
      >
        ...
        >
          ...
          <View style={styles.ctaText}>
            <Text style={styles.ctaTitle}>Start New Inspection</Text>
            <Text style={styles.ctaSubtitle}>Tap to begin tyre checklist</Text>
          </View>
                ...
                <View style={styles.recentInfo}>
                  ...
                  <Text style={styles.recentMeta}>
                    {item.site} · {item.asset_number} · {
                      new Date(item.inspection_date).toLocaleDateString('en-GB', {
        ...
        {recentInspections.length === 0 && (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubtitle}>
              Tap "Start New Inspection" above to begin
            </Text>
          </View>
        )}
      </ScrollView>
