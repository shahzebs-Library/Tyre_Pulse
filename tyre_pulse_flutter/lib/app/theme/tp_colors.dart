...
///
/// These values are ported from the production React Native design tokens in
/// `mobile/lib/theme.ts` so the two applications do not drift apart while both
/// are in the field.
library;
...
class TpPalette {
  ...
  static const TpPalette dark = TpPalette(
    ...
    surfaceSunken: Color(0xFF0E1728),
    ...
    primarySoft: Color(0xFF16301F),
    onPrimary: Color(0xFF04140A),
    border: Color(0xFF243248),
    borderStrong: Color(0xFF33455F),
    focus: Color(0xFF22C55E),
