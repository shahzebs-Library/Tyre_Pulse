...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/repair-requests',     label: 'Repair Requests (RFR)', parent: 'Jobs', icon: ClipboardList, roles: ANALYTICS_ROLES },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/store-material-issue', label: 'Material Issue (MIS)', parent: 'Stock', icon: Receipt, roles: ['Admin', 'Manager', 'Director'] },
