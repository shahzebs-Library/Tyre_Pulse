...
const h = vi.hoisted(() => ({ country: 'KSA', language: 'en', load: vi.fn(), people: vi.fn(), sites: vi.fn(), roles: vi.fn(), save: vi.fn(), publish: vi.fn(), retire: vi.fn(), simulate: vi.fn(), events: vi.fn() }))
...
vi.mock('../contexts/AuthContext', () => ({ useAuth: () => ({ profile: { id: 'admin', org_id: 'org' } }) }))
