...
const PlannerCoveragePanel = lazy(() => import('../components/inspection-planner/PlannerCoveragePanel'))
...
function PlannerWorkspace({ country, permissions }) {
  ...
  const navigation = [['queue', copy('Work queue', 'قائمة الأعمال')], ['plan', copy('Plan & adherence', 'الخطة والالتزام')], ['agenda', copy('Agenda', 'جدول المواعيد')], ['coverage', copy('Coverage', 'التغطية')], ['inspectors', copy('Inspectors', 'الفاحصون')], ['analytics', copy('Analytics', 'التحليلات')]]
