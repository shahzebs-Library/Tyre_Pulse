...
describe('vehicle washing PDFs', () => {
  it('includes entry attribution and chemical details without legacy checklist data', async () => {
    ...
    expect(text).toContain('Recorder');expect(text).toContain('Recorded product');expect(text).not.toContain('Dust remains')
  })
