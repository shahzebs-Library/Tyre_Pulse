...
void main() {
  group('syncErrorClassFor', () {
    ...
    const Map<SupabaseFailureCause, String> expected =
        <SupabaseFailureCause, String>{
          ...
          SupabaseFailureCause.onConflictInferenceFailed:
    ...
    test('the fixture covers every SupabaseFailureCause value', () {
      expect(
        ...
        reason:
            'a cause missing from this table would silently fall '
    ...
    test('uniqueViolation always maps to conflict regardless of the caller - '
