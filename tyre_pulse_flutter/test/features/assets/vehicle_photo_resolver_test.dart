...
void main() {
  group('asset-number fallback parity', () {
    const Map<String, String> expectedPhotos = <String, String>{
      ...
      'PL-090': 'assets/vehicle_photos/pickup.png',
    ...
    test('SL uses its dedicated skid-loader artwork', () {
      ...
      expect(
        ...
        'assets/vehicle_photos/skid_loader_fleet.jpeg',
      );
  ...
  test('double-cabin variants use the bundled pickup artwork', () {
    const VehicleAsset asset = VehicleAsset(
      id: 'vehicle-double-cab',
      vehicleType: 'Double Cabin Pickup',
    );

    expect(vehiclePhotoAsset(asset), 'assets/vehicle_photos/pickup.png');
  ...
  group('tyreless equipment', () {
    ...
    for (final String description in descriptions) {
      test('$description never borrows vehicle artwork', () {
        ...
        final String? expected = switch (description) {
          'Generator' ||
          'Genset' =>
            'assets/vehicle_photos/generator_fleet.jpeg',
          'Chiller' => 'assets/vehicle_photos/chiller_fleet.jpeg',
          'Batching Plant' => 'assets/vehicle_photos/batching_plant_fleet.jpeg',
          'Placing Boom' => 'assets/vehicle_photos/placing_boom_vertical.jpeg',
          'Stationary Pump' =>
            'assets/vehicle_photos/stationary_pump_fleet.jpeg',
          _ => null,
        };
        expect(vehiclePhotoAsset(asset), expected);
        expect(
    ...
    const Map<String, String?> documentedTyrelessPrefixes = <String, String?>{
      'GN103': 'assets/vehicle_photos/generator_fleet.jpeg',
      'BP014': 'assets/vehicle_photos/batching_plant_fleet.jpeg',
      'IP-005': null,
      'SP 021': 'assets/vehicle_photos/stationary_pump_fleet.jpeg',
      'PB008': 'assets/vehicle_photos/placing_boom_vertical.jpeg',
    };
