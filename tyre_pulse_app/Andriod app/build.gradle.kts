...
android {
    ...
    buildTypes {
        release {
            isMinifyEnabled = true // Agent 47: R8 Code Shrinking
            isShrinkResources = true // Agent 47: Resource Pruning
            proguardFiles(getDefaultProguardFile("proguard-android-optimize.txt"), "proguard-rules.pro")
            
            signingConfig = signingConfigs.getByName("debug") // Placeholder for production
        }
    }
